...
export class ChartJsElement extends HTMLElement {
    ...
    _parseChartData(mutationList = []) {
        const removedNodes = mutationList.reduce((allList, mutList) => allList = [...allList, ...mutList.removedNodes], []);
        // TODO: Clean up
        /** @type Element[] */
        ...
        datasets.forEach((dataset, i) => {
            this._parseDataset(dataset, mutationList, i, true);
        });
     ...
     */
    _parseDataset(datasetElement, mutationList, datasetIndex, multiDataset) {
