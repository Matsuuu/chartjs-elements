...
import { chartColor, getActiveIndex, isDataElement, isDatasetElement, isSubtitleElement, isTitleElement, waitForInitialization } from './util.js';
    ...
    _parseOptions() {
        ...
        if (titleElement) {
            this.options.plugins.title = {
                ...
                padding: titleElement.padding ? Number(titleElement.padding) : 10,
                color: titleElement.color ?? Chart.defaults.color,
                fullSize: titleElement.fullSizeAsBoolean,
                font: {
                    size: titleElement.size ? Number(titleElement.size) : 12,
                },
            };
        }
