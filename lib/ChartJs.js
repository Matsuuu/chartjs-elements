...
import { chartColor, isDatasetElement, useDatasetIndex } from './util';
...
export class ChartJsElement extends HTMLElement {
    ...
    _parseDataset(datasetElement, datasetIndex, multiDataset) {
        ...
        for (let i = 0; i < dataElements.length; i++) {
            ...
            dataset.backgroundColor[i] = dataEl.backgroundColor ?? chartColor(multiDataset ? datasetIndex : i);
            dataset.borderColor[i] = dataEl.borderColor ?? chartColor(multiDataset ? datasetIndex : i, false);
        }
